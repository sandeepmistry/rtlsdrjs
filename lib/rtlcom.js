...
function RtlCom(conn) {
  ...
  function readCtrlMsg(value, index, length, kont) {
    ...
    conn.controlTransfer(ti, function(error, data) {
  ...
  function writeCtrlMsg(value, index, buffer, kont) {
    ...
    conn.controlTransfer(ti, function(error) {
      if (VERBOSE) {
  ...
  function readBulk(length, kont) {
    ...
    conn.bulkTransfer(ti, function(error, data) {
      if (VERBOSE) {
